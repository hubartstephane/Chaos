...
#define CHAOS_CAN_REDIRECT_RESOURCE_FILES (_DEBUG && defined CHAOS_PROJECT_BUILD_PATH && (defined CHAOS_PROJECT_SRC_PATH || defined CHAOS_PROJECT_DIRECT_RESOURCE_PATH))
