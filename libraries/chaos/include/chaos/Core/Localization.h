...
// use as follow:
//
//    CHAOS_PP_UNICODE_TO_UTF8(a,b,c,d,e)
//    CHAOS_PP_UNICODE_TO_UTF8(b,c,d,e) 
//    CHAOS_PP_UNICODE_TO_UTF8(c,d,e) 
//    CHAOS_PP_UNICODE_TO_UTF8(d,e) 
//    CHAOS_PP_UNICODE_TO_UTF8(e) 
//
//    a,b,c,d,e are nibbles to the unicode codepoint
...
#define CHAOS_PP_UNICODE_TO_UTF8_IMPL_1(e) CHAOS_PP_UNICODE_TO_UTF8_HELPER(0,0,0,0,e)
#define CHAOS_PP_UNICODE_TO_UTF8_IMPL_2(d,e) CHAOS_PP_UNICODE_TO_UTF8_HELPER(0,0,0,d,e)
#define CHAOS_PP_UNICODE_TO_UTF8_IMPL_3(c,d,e) CHAOS_PP_UNICODE_TO_UTF8_HELPER(0,0,c,d,e)
#define CHAOS_PP_UNICODE_TO_UTF8_IMPL_4(b,c,d,e) CHAOS_PP_UNICODE_TO_UTF8_HELPER(0,b,c,d,e)
#define CHAOS_PP_UNICODE_TO_UTF8_IMPL_5(a,b,c,d,e) CHAOS_PP_UNICODE_TO_UTF8_HELPER(a,b,c,d,e)

#define CHAOS_PP_UNICODE_TO_UTF8_HELPER(a,b,c,d,e) CHAOS_PP_UNICODE_TO_UTF8_HELPER_IMPL(CHAOS_PP_NIBLE_TOUPPER(a),CHAOS_PP_NIBLE_TOUPPER(b),CHAOS_PP_NIBLE_TOUPPER(c),CHAOS_PP_NIBLE_TOUPPER(d), CHAOS_PP_NIBLE_TOUPPER(e))

#define CHAOS_PP_UNICODE_TO_UTF8_HELPER_IMPL(a,b,c,d,e)\
BOOST_PP_IF(\
...
#define CHAOS_PP_UNICODE_TO_UTF8_4(a,b,c,d,e) CHAOS_PP_UNICODE_TO_UTF8_4_IMPL(a,b,c,d,e)
...
#define CHAOS_PP_UNICODE_TO_UTF8_3(a,b,c,d,e) CHAOS_PP_UNICODE_TO_UTF8_3_IMPL(a,b,c,d,e)
...
#define CHAOS_PP_UNICODE_TO_UTF8_2(a,b,c,d,e) CHAOS_PP_UNICODE_TO_UTF8_2_IMPL(a,b,c,d,e)
...
#define CHAOS_PP_UNICODE_TO_UTF8_1(a,b,c,d,e) CHAOS_PP_UNICODE_TO_UTF8_1_IMPL(a,b,c,d,e)
