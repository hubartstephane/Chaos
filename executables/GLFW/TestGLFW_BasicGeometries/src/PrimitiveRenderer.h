...
public:
	...
	chaos::shared_ptr<chaos::GPUSimpleMesh> mesh_triangle;
	chaos::shared_ptr<chaos::GPUSimpleMesh> mesh_sphere;
	chaos::shared_ptr<chaos::GPUSimpleMesh> mesh_circle;
	chaos::shared_ptr<chaos::GPUSimpleMesh> mesh_quad;
