namespace chaos
{
	...
	public:
		...
		virtual GPURenderMaterial* LoadObject(char const* name, JSONConfig const & config) const;
	...
	protected:
		...
		bool InitializeMaterialInfoFromJSON(GPURenderMaterial* render_material, GPURenderMaterialInfo* material_info, JSONConfig const & config) const;
		...
		bool InitializeProgramFromJSON(GPURenderMaterialInfo* material_info, JSONConfig const & config) const;
		/** get the textures from JSON */
		bool InitializeTexturesFromJSON(GPURenderMaterialInfo* material_info, JSONConfig const & config) const;
		/** get the uniforms from JSON */
		bool InitializeUniformsFromJSON(GPURenderMaterialInfo* material_info, JSONConfig const & config) const;
		/** get the renderpasses from JSON */
		bool InitializeRenderPassesFromJSON(GPURenderMaterial* render_material, GPURenderMaterialInfo* material_info, JSONConfig const & config) const;
