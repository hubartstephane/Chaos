...
protected:
	...
	virtual bool OnDraw(chaos::GPURenderContext * render_context, chaos::GPUProgramProviderInterface const * uniform_provider, chaos::WindowDrawParams const& draw_params) override
	{
		...
		glm::mat4 projection_matrix      = glm::perspectiveFov(chaos::MathTools::DegreeToRadian(FOV), 2.0f * float(draw_params.viewport.size.x), float(draw_params.viewport.size.y), 1.0f, far_plane);
