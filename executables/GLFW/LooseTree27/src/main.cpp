...
public:
	...
	static auto Visit(
		...
		FUNC const& in_func) -> chaos::meta::LambdaInfo<FUNC, decltype(tree27.GetRootNode()), typename LOOSE_TREE27_TYPE::plane_type const*, size_t, uint32_t>::result_type
	{
...
protected:
	...
	public:
		...
		auto Visit(LOOSE_TREE27_TYPE& tree27) -> chaos::meta::LambdaInfo<FUNC, decltype(tree27.GetRootNode()), plane_type const*, size_t, uint32_t>::result_type
		{
	...
	protected:
		...
		auto Visit(NODE27_TYPE* node, uint32_t plane_bitfield) -> chaos::meta::LambdaInfo<FUNC, NODE27_TYPE*, plane_type const*, size_t, uint32_t>::result_type
		{
			...
			bool node_rejected = chaos::BitTools::ForEachBitForward(plane_bitfield, [&](uint32_t index)
			{
...
protected:
	...
	void DrawGeometryObjects()
	{
		...
		else
		{
			...
			Tree27PlaneClipVisitor::Visit(object_tree, &planes[0], planes.size(), [&](loose_tree_node_type const* node, glm::vec4 const* planes, size_t plane_count, uint32_t plane_bitfield)
			{
