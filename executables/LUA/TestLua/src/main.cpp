...
int _tmain(int argc, char ** argv, char ** env)
{
  ...
  StartLuaFile(resources_path / "test1.lua", WorkWithLua1, EnrichLuaState1);

  chaos::LogTools::DisplayTitle("Test2.lua : calling C++ function from LUA");
  StartLuaFile(resources_path / "test2.lua", WorkWithLua2, EnrichLuaState2);

  chaos::LogTools::DisplayTitle("Test3.lua : a syntax error");
  StartLuaFile(resources_path / "test3.lua", WorkWithLua3, EnrichLuaState3);

  chaos::LogTools::DisplayTitle("Test4.lua : a runtime error");
  StartLuaFile(resources_path / "test4.lua", WorkWithLua4, EnrichLuaState4);

  chaos::LogTools::DisplayTitle("Test5.lua : calling LUA function from C++");
  StartLuaFile(resources_path / "test5.lua", WorkWithLua5, EnrichLuaState5);
