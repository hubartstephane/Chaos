...
build:ProcessSubPremake("Ludum46-BurnaoufParadise")
build:ProcessSubPremake("Ludum47-AoufRun")
build:ProcessSubPremake("Ludum48-BouldaoufDash")
build:ProcessSubPremake("Ludum49-NotToday")