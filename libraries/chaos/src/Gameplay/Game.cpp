...
namespace chaos
{
	...
	{
		if (in_action_enumerator(IsKeyPressed(KeyboardButton::ESCAPE).RequireModifiers(KeyModifier::Shift) , "Exit Game", [this]()
		{
			RequireExitGame();
		}))
		{
		...
		if (in_action_enumerator(IsKeyPressed(KeyboardButton::ESCAPE), "Toggle Pause", [this]()
		{
			RequireTogglePause();
		}))
		{
		...
		if (in_action_enumerator(IsKeyPressed(KeyboardButton::F1) , "Skip Level", [this]()
		{
		...
		if (in_action_enumerator(IsKeyPressed(KeyboardButton::F2), "Toggle Cheat Mode", [this]()
		{
		...
		if (in_action_enumerator(IsKeyPressed(KeyboardButton::F3), "Reload Configuration", [this]()
		{
		...
		if (in_action_enumerator(IsKeyPressed(KeyboardButton::F4), "Reload Current Level", [this]()
		{
			ReloadCurrentLevel();
		}))
		{
		...
		if (in_action_enumerator(IsKeyPressed(KeyboardButton::F5), "Quick Save", [this]()
		{
			SaveIntoCheckpoint();
		}))
		{
		...
		if (in_action_enumerator(IsKeyPressed(KeyboardButton::F6), "Toggle Free Camera Mode", [this]()
		{
