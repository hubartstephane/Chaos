...
public:
	...
	void ParticleToPrimitives(ParticleBlood const& particle, chaos::GPUPrimitiveOutput<VertexBase>& output) const;
...
public:
	...
	void ParticleToPrimitives(ParticleBurnedSoul const& particle, chaos::GPUPrimitiveOutput<VertexBase>& output, int useless) const;
