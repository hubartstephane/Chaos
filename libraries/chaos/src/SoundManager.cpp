...
namespace chaos
{
	...
	SoundSource * SoundManager::AddSource(FilePath const & in_path)
	{
		return AddSource(in_path, in_path.path.string().c_str());
	}

	SoundSource * SoundManager::AddSource(FilePath const & in_path, char const * in_name)
	{
