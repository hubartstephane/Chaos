namespace chaos
{
	...
	**/
	...
	protected:
		...
		virtual bool LoadTexturesFromConfiguration(JSONConfig const & config);
		/** load the programs from configuration */
		virtual bool LoadProgramsFromConfiguration(JSONConfig const & config);
		/** load the materials from configuration */
		virtual bool LoadMaterialsFromConfiguration(JSONConfig const & config);
