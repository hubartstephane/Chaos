...
// turn any byte hexadecimal representation into upper case (and turn it with 2 figures)
#define CHAOS_PP_BYTE_TOUPPER(x) CHAOS_PP_BYTE_TOUPPER_IMPL(x)
...
//
//    Here are some example of expected encoding
// 
