namespace chaos
{
	...
	public:
		...
		/** constructor */
		OnPollInputActionEnumerator(InputEventReceiverInterface const* in_event_receiver, InputDeviceInterface const* in_input_device, InputConsumptionCache* in_consumption_cache);
