...
protected:
	...
	{
		if (in_action_enumerator.CheckAndProcess(KeyPressed(chaos::Key::KP_ADD), "Next Font", [this]()
		{
		...
		if (in_action_enumerator.CheckAndProcess(KeyPressed(chaos::Key::KP_SUBTRACT), "Previous Font", [this]()
		{
			ChangeFont(font_index - 1);
		}))
		{
