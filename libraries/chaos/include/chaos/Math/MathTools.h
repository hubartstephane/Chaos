namespace chaos
{
	...
	namespace MathTools
	{
		...
		CHAOS_API unsigned int GetMantissa(float f);

		/** returns the exponent of a float */
		CHAOS_API int GetExponent(float f);
		...
		CHAOS_API void ResetRandSeed();

		/** returns a random float between [0..1] */
		CHAOS_API float RandFloat();

		/** returns a random float between X and Y */
		CHAOS_API float RandFloat(float min_value, float max_value);
