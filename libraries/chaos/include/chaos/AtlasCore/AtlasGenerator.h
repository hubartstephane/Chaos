namespace chaos
{
	...
	*/
	...
	public:
		...
		/** the filters to be applied to each bitmaps */
	...
	*/
	...
	public:
		...
		std::vector<bitmap_ptr> GenerateBitmaps(AtlasBitmapInfoInputVector const& entries, PixelFormat pixel_format) const;
