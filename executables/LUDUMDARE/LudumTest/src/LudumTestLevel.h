...
protected:
	...
	virtual bool OnPlayerTileCollision(float delta_time, class death::Player* player, death::TiledMapLayerInstance* layer, std::vector<death::TileParticleCollisionInfo> const& colliding_tiles) override;
};
